...
parser.add_argument("--validator", choices=("fixture", "real"), default="fixture")
...
script, phase = ("validate_real.py", "nwb") if args.validator == "real" else ("validate.py", "full")
os.execvpe(sys.executable, [sys.executable, "-u", str(here / script), phase, *remaining], env)
